...
INSERT INTO `tili` VALUES (2,1,40,0),(3,1,0,500),(4,4,1663,0),(5,5,786,0),(6,5,0,500),(7,6,1320,0),(8,7,2460,0),(9,7,0,1500);
...
COMMIT; 
  ...
  SET test1=ROW_COUNT();
  COMMIT;
  IF (select luottoraja from tili where id_tilinumero=tokatili_id >0) THEN
  COMMIT;
...
-- Dump completed on 2022-12-05 13:29:56
